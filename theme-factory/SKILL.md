...
1. New themes are added to the themes/ directory
2. Existing themes are renamed or removed
3. Theme application process changes
4. theme-showcase.pdf is regenerated with different themes
5. Font/color specification format changes

**HOW to update:**
1. Edit this file at `~/.agents/skills/theme-factory/SKILL.md` using the Edit tool
...
**WHEN NOT to update:**
- Custom themes created for one-off use
